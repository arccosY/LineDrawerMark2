...
public class Main extends JFrame {
    ...
    public static void draw(Graphics2D g) {
        ...
        //Рисуем кадр.
        int a=969, b=512,c=220,d=220;
        double e,f;
        for (double i = 1; i < 80000; i++) {
            double u=Math.toRadians(i);
            e = (70 * Math.cos(u)) + a;
            f = (70 * Math.sin(u)) + b;
            c = (int) e;
            d = (int) f;
            Render.renderLine(img, a, b, c, d, Color.BLACK.getRGB());

            System.out.println(Math.cos(u)+" "+u);
        }
